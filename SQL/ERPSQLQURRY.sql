...
CREATE TABLE CompanyDatabase (
    ...
    CONSTRAINT FK_CompanyDatabase_Address FOREIGN KEY (AddressId) REFERENCES AddressDatabase(AddressId) ON DELETE SET NULL
...
CREATE TABLE CustomerDatabase (
    ...
    CONSTRAINT FK_CustomerDatabase_Address FOREIGN KEY (AddressId) REFERENCES AddressDatabase(AddressId) ON DELETE SET NULL
);
GO
